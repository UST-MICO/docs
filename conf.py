...
latex_documents = [
    (master_doc, 'MICO.tex', 'MICO Documentation',
     'MICO Authors', 'manual'),
]
...
man_pages = [
    (master_doc, 'mico', 'MICO Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'MICO', 'MICO Documentation',
     author, 'MICO', 'One line description of project.',
     'Miscellaneous'),
]
...
intersphinx_mapping = {
    ...
    'mico-dev': ('https://mico-dev.readthedocs.io/en/latest/', None),
}
